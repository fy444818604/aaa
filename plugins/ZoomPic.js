...
{this.css(this.aSort[i],"display","none");this.css(this.aSort[i],"width",0);this.css(this.aSort[i],"height",0);this.css(this.aSort[i],"top",65);this.css(this.aSort[i],"left",this.oUl.offsetWidth/2)}
